...
public class DecryptResource extends CordovaPlugin {
    ...
    private static final String CRYPT_KEY = "mX+Q3Ihjt6Kn+l7oE2yqoWQfpb5OmwDa";
    private static final String CRYPT_IV = "xMz/3tDNePDe9eSO";
    private static final String[] INCLUDE_FILES = new String[] { "tester.js", "\\.(htm|html|js|css)$" };
